                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white text-slate-800 p-8 rounded-lg shadow-lg">
                            ...
                            <p className="text-center text-gray-600 mb-6">
                                Interested in KiteFoot? Just pick up the phone to chat with a member of our sales team.
                            </p>
                            <div className="text-center">
                                <a href="tel:+919649486218" className="text-blue-600 font-semibold text-lg block mb-4">
                                    +919649486218
                                </a>
                        ...
                        <div className="bg-white text-slate-800 p-8 rounded-lg shadow-lg">
                            ...
                            <p className="text-center text-gray-600 mb-6">
                                Sometimes you need a little help from your friends. Or a KiteFoot support rep. Don't worry... we're here for you.
                            </p>
                            <div className="text-center">
                                <a
