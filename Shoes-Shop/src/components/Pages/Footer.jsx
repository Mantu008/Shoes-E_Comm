        ...
        <footer className="bg-gray-900 text-white py-8">
            <div className="container mx-auto text-center px-4">
                ...
                <div className="mb-4 flex justify-center flex-wrap">
                    <input
                        type="text"
                        className="p-2 w-64 md:w-1/2 lg:w-1/3 mb-4 md:mb-0 border-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500"
                        placeholder="Enter your email"
                    />
                    <button className="bg-orange-500 text-white p-2 hover:bg-orange-600 transition">SUBSCRIBE</button>
                </div>
